...
// ----------------------------------------------
// 2. İSTANBUL ROTALARI (Gerçek Google Maps linkleri)
// ----------------------------------------------
const routes = [
    {
        name: "🏛️ Tarihi Yarımada Rotası",
        places: [
            { name: "Ayasofya", link: "https://www.google.com/maps/place/Ayasofya/@41.0086,28.9802,17z" },
            { name: "Sultanahmet Camii", link: "https://www.google.com/maps/place/Sultan+Ahmed+Camii/@41.0054,28.9768,17z" },
            { name: "Yerebatan Sarnıcı", link: "https://www.google.com/maps/place/Yerebatan+Sarn%C4%B1c%C4%B1/@41.0084,28.9779,17z" }
        ]
    },
    {
        name: "🌆 Boğaz Kenarı Keyfi",
        places: [
            { name: "Ortaköy", link: "https://www.google.com/maps/place/Ortak%C3%B6y,+Be%C5%9Fikta%C5%9F/@41.0559,29.0276,17z" },
            { name: "Bebek Sahili", link: "https://www.google.com/maps/place/Bebek,+Be%C5%9Fikta%C5%9F/@41.0774,29.0431,17z" },
            { name: "Arnavutköy", link: "https://www.google.com/maps/place/Arnavutk%C3%B6y,+Be%C5%9Fikta%C5%9F/@41.0682,29.0431,17z" }
        ]
    },
    {
        name: "🎨 Sanat ve Kültür Rotası",
        places: [
            { name: "İstanbul Modern", link: "https://www.google.com/maps/place/%C4%B0stanbul+Modern/@41.0268,28.9794,17z" },
            { name: "Galata Kulesi", link: "https://www.google.com/maps/place/Galata+Kulesi/@41.0256,28.9741,17z" },
            { name: "Pera Müzesi", link: "https://www.google.com/maps/place/Pera+M%C3%BCzesi/@41.0314,28.9751,17z" }
        ]
    },
    {
        name: "🌳 Adalar Kaçamağı",
        places: [
            { name: "Büyükada", link: "https://www.google.com/maps/place/B%C3%BCy%C3%BCkada/@40.8667,29.1167,14z" },
            { name: "Heybeliada", link: "https://www.google.com/maps/place/Heybeliada/@40.8778,29.0833,15z" },
            { name: "Burgazada", link: "https://www.google.com/maps/place/Burgazada/@40.8833,29.0667,15z" }
        ]
    },
    {
        name: "🛍️ Kadıköy - Moda Hattı",
        places: [
            { name: "Kadıköy Çarşı", link: "https://www.google.com/maps/place/Kad%C4%B1k%C3%B6y/@40.9906,29.0299,16z" },
            { name: "Moda Sahili", link: "https://www.google.com/maps/place/Moda,+Kad%C4%B1k%C3%B6y/@40.9811,29.0252,16z" },
            { name: "Barış Manço Evi", link: "https://www.google.com/maps/place/Bar%C4%B1%C5%9F+Man%C3%A7o+Evi/@40.9744,29.0533,17z" }
        ]
    }
];

// ----------------------------------------------
// 3. GÜNÜN RENGİ VE ŞARKISI (Çalışan YouTube Video ID'leri)
// ----------------------------------------------
const colorsOfDay = [
...
const songsOfDay = [
    ...
    { title: "Küçüğüm", artist: "Sezen Aksu", videoId: "6dSOWZ6q_Xw" },
...
function generateSurprise() {
    ...
    // Favori butonlarını ekle (bir kere)
...
function renderFavorites() {
    ...
    if (favorites.length === 0) {
        ...
        favorites.forEach((fav, index) => {
            ...
            li.innerHTML = `<span>${fav}</span><button class="fav-remove-btn">🗑️</button>`;
            li.querySelector('.fav-remove-btn').addEventListener('click', () => {
...
function setDailySong() {
    ...
    player.src = `https://www.youtube.com/embed/${song.videoId}?autoplay=1&mute=1&controls=0&loop=1&playlist=${song.videoId}`;
}
